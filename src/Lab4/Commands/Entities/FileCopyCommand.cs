...
public class FileCopyCommand : ICommand
{
    ...
    private FileCopyCommand(IPath sourcePath, IPath destinationPath)
    {
        _sourcePath = sourcePath;
        _destinationPath = destinationPath;
    }

    public static FileCopyCommandBuilder Builder => new();

    public CommandStatus Execute(IContext context)
    {
           return context.FileSystem.FileCopy(context.Address, _sourcePath, _destinationPath);
    }
    ...
    public class FileCopyCommandBuilder : ICommandBuilder
    {
        ...
        public FileCopyCommandBuilder SetSourcePath(IPath sourcePath)
        {
            _sourcePath = sourcePath;
            return this;
        }

        public FileCopyCommandBuilder SetDestinationPath(IPath destinationPath)
        {
            _destinationPath = destinationPath;
            return this;
        }
        ...
        public ParseCommandStatus Build()
        {
            ...
            return new ParseCommandStatus.Success(new FileCopyCommand(_sourcePath, _destinationPath));
        }
    }
}